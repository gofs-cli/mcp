...
func main() {
	...
	mcp.AddTool(server, &mcp.Tool{Name: "GofsDocumentationMarkdown", Description: "Fetch gofs documentations markdown from the given URL."}, tools.FetchMarkdown)
	mcp.AddTool(server, &mcp.Tool{Name: "GofsDocumentationCategories", Description: "Fetch all the possible categories that can be used by fetch_documentation_category"}, tools.FetchCategories)
	mcp.AddTool(server, &mcp.Tool{Name: "GofsDocumentationCategoryMarkdown", Description: "Fetch all the documentation in a folder, folder can be with the fetch_documentation_category"}, tools.FetchCategoryMarkdown)
